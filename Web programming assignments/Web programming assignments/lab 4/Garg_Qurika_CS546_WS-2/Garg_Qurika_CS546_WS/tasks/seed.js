...
.then(()=>{
      //  console.log("5th class added")
            return classes.addClass("CS-600","Advance Algorithm", "Prof. ABCD","algorithms in details and Algorithm design and computational complexity at advance level")
